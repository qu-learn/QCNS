...
//         console.log('QCNS initialized successfully');
//         showNotification('🔬 QCNS initialized successfully! Ready to build quantum circuits.', 'success');
        
//     } catch (error) {
//         console.error('Initialization error:', error);
//         showNotification('Failed to initialize QCNS: ' + error.message, 'error');
//     }
// });